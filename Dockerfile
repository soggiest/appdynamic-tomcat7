...
RUN keytool --importcert -alias AppRootCA -file /tmp/DigiCertGlobalRootCA -keystore /usr/lib/jvm/java-1.8.0-openjdk-1.8.0.45-30.b13.el7_1.x86_64/jre/lib/security/cacerts
RUN keytool --importcert -alias AppdSecureCA -file /tmp/DigiCertSHA2SecureServerCA -keystore /usr/lib/jvm/java-1.8.0-openjdk-1.8.0.45-30.b13.el7_1.x86_64/jre/lib/security/cacerts
RUN keytool --importcert -alias AppRootCA -file /tmp/saas.appdynamics.com.cer -keystore /usr/lib/jvm/java-1.8.0-openjdk-1.8.0.45-30.b13.el7_1.x86_64/jre/lib/security/cacerts
